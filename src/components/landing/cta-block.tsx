  ...
  return (
    <section id="checkout" className="w-full flex justify-center">
        <div className="w-full max-w-2xl bg-gradient-to-br from-brand-red/95 via-red-900/90 to-black/80 border-2 border-brand-yellow-border rounded-xl shadow-glow-yellow p-6 md:p-8 space-y-6 text-center text-primary-foreground flex flex-col items-center backdrop-blur-sm">
            ...
            <div className="flex items-center gap-2 font-semibold bg-black/30 px-4 py-2 rounded-full border border-white/10">
            ...
            <div className="flex items-center justify-center">
                <span className="text-3xl font-bold text-white/80 -translate-y-2 mr-1">R$</span>
                <span className="text-7xl md:text-8xl font-black text-brand-yellow leading-none">{priceInteger}</span>
                <span className="text-3xl font-bold text-brand-yellow -translate-y-2 ml-1">,{priceFraction}</span>
            </div>

            <p className="font-bold text-lg uppercase tracking-wider text-white/80">
                Acesso Imediato Após Pagamento
            </p>

            <a href={checkoutUrl} target="_blank" rel="noopener noreferrer" className="w-full">
                <Button size="lg" className="w-full h-16 text-lg md:text-xl font-bold rounded-md bg-gradient-to-r from-brand-yellow to-amber-300 text-primary-foreground shadow-lg hover:scale-105 active:scale-95 transition-transform duration-200 border-t-2 border-white/50">
